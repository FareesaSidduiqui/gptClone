    ...
    transition-all duration-500 max-md:absolute left-0 z-1 ${!isMenuOpen && 
      ...
      >
        <img
          ...
          className="w-4.5 h-5 object-contain not-dark:invert"
          alt=""
        />
      ...
      >
        <img
          ...
          className="w-4.5 h-5 object-contain dark:invert"
          alt=""
        />
        <div className="flex flex-col text-sm">
      ...
      <div className="flex items-center justify-between p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md">
        ...
        <label className="relative inline-flex items-center cursor-pointer">
          <input
            ...
            readOnly
          />
          <div className="w-9 h-5 bg-gray-400 rounded-full peer-checked:bg-purple-600 transition-colors">
      ...
      <img onClick={()=>setIsMenuOpen(false)}src={assets.close_icon} className="absolute top-3 right-3 w05 h-5 cursor-pointer md:hidden not-dark:invert" alt="" />
    </div>
  );
}
